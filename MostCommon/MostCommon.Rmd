...
You can also explore the following interactive plot, you can choose to show all families, or one of the top ten families with the most species, and check the number of occurrence per species, by hovering over the barplot.

You can play with the controls and zoom in and out, or copy download a copy of the plot using the camera icon.
