...
```{r}
ggplot(PerFamily, aes(x = reorder(Family, desc(Species_number)), y = Species_number)) + geom_col() + theme_bw() + labs(x = "Family", y = "Speceis Number") + theme(axis.text.x = element_blank(), axis.ticks =element_blank())
```
