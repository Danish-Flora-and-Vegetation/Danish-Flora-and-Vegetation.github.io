...
In table \@ref(tab:EllenbergTable) you can see the percentage of species that are within an ellenberg value as well as the most common species having that value. 
