...
Habitat_Types <- read_delim("Habitat_Types.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE) |> 
  mutate(MajorHabName =  iconv(MajorHabName, from="Windows-1252", to="UTF-8"), MajorHab = as.character(MajorHab)) 
...
filter_checkbox("Major Habitat", "MajorHabName", sd1, ~MajorHabName, inline = T)
